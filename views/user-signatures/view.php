...
<body>
    ...
    <p>
        <?= Html::a('Update', ['update', 'signature_id' => $model->signature_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'signature_id' => $model->signature_id], [
