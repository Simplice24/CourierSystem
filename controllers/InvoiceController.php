...
class InvoiceController extends Controller
{
    ...
    {
        $model = new Invoice();
        $model->customer_name = Yii::$app->request->post('Invoice')['customer_name'];
        $selectedItems = Yii::$app->request->post('Item')['selected'];
        $model->item_name=$selectedItems;
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                if($model->save()){
                    ...
                    $log->comment="Invoice is generated";
