...
<div class="row" style="height:90px;">
    ...
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="form-group">
                <?= $form->field($model, 'signature_image')->fileInput(['class' => 'btn btn-gradient-primary'])->label(false) ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group row">
            <?php
                // Hide the input field and set its value to the ID of the currently authenticated user
